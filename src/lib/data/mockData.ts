...
const FIRST_NAMES = [
  'Hans', 'Peter', 'Anna', 'Maria', 'Thomas', 'Sarah', 'Michael', 'Julia',
  'Daniel', 'Laura', 'Stefan', 'Sophie', 'Martin', 'Emma', 'Christian', 'Lisa',
];
...
export const mockPatients: Patient[] = [
  {
    ...
    medications: ['Aspirin 100mg daily', 'Metoprolol 50mg twice daily', 'Atorvastatin 20mg evening'],
    conditions: ['Hypertension', 'Type 2 Diabetes', 'Previous MI (2019)', 'Atrial Fibrillation'],
    emergencyContacts: [
      { name: 'Maria Schmidt', phone: '+41 79 123 4567', relationship: 'Wife' },
      { name: 'Dr. Hans Weber', phone: '+41 44 123 4567', relationship: 'Cardiologist' },
    ],
    location: {
      lat: 47.3769,
      lng: 8.5417,
  ...
  },
  {
    ...
    emergencyContacts: [
      { name: 'Thomas Müller', phone: '+41 79 234 5678', relationship: 'Husband' },
  ...
  },
  {
    ...
    emergencyContacts: [
      { name: 'Sophie Fischer', phone: '+41 79 456 7890', relationship: 'Daughter' },
      { name: 'Pflegeheim Sonnenhof', phone: '+41 44 234 5678', relationship: 'Care Facility' },
    ],
    location: {
      lat: 47.3747,
      lng: 8.5494,
  ...
  },
  {
    ...
    medications: ['Insulin Glargine 24 units bedtime', 'Metformin 1000mg twice daily'],
    conditions: ['Type 1 Diabetes', 'Diabetic Neuropathy', 'Retinopathy'],
    emergencyContacts: [
      { name: 'Lisa Keller', phone: '+41 79 567 8901', relationship: 'Partner' },
      { name: 'Dr. Stefan Meier', phone: '+41 44 345 6789', relationship: 'Endocrinologist' },
    ],
    location: {
      lat: 47.3686,
      lng: 8.5391,
  ...
  },
  {
    ...
    emergencyContacts: [
      { name: 'Sandra Zimmermann', phone: '+41 79 678 9012', relationship: 'Wife' },
      { name: 'Dr. Peter Huber', phone: '+41 44 456 7890', relationship: 'Cardiac Surgeon' },
    ],
    location: {
      lat: 47.3812,
      lng: 8.5450,
  ...
  },
  {
    ...
    emergencyContacts: [
      { name: 'Michael Berg', phone: '+41 79 789 0123', relationship: 'Boyfriend' },
      { name: 'Dr. Julia Schneider', phone: '+41 44 567 8901', relationship: 'Allergist' },
    ],
    location: {
      lat: 47.3720,
      lng: 8.5380,
  ...
  },
  {
    ...
    conditions: ["Parkinson's Disease", 'Mild Cognitive Impairment', 'Postural Hypotension'],
    emergencyContacts: [
      { name: 'Claudia Steiner', phone: '+41 79 890 1234', relationship: 'Daughter' },
      { name: 'Spitex Zürich', phone: '+41 44 678 9012', relationship: 'Home Care' },
    ],
    location: {
      lat: 47.3790,
      lng: 8.5370,
  ...
  },
  {
    ...
    bloodType: 'O+',
    allergies: ['None known'],
    medications: ['Levetiracetam 1000mg twice daily', 'Lamotrigine 200mg twice daily'],
    conditions: ['Epilepsy (Generalized Tonic-Clonic)', 'Last seizure 3 months ago'],
    emergencyContacts: [
      { name: 'Petra Vogel', phone: '+41 79 901 2345', relationship: 'Mother' },
      { name: 'Dr. Andreas Bauer', phone: '+41 44 789 0123', relationship: 'Neurologist' },
    ],
    location: {
      lat: 47.3665,
      lng: 8.5510,
  ...
  },
  {
    ...
    conditions: ['Rheumatoid Arthritis', 'Osteoporosis', 'GERD', 'Immunosuppressed'],
    emergencyContacts: [
      { name: 'Robert Lang', phone: '+41 79 012 3456', relationship: 'Husband' },
      { name: 'Dr. Monika Graf', phone: '+41 44 890 1234', relationship: 'Rheumatologist' },
    ],
    location: {
      lat: 47.3830,
      lng: 8.5480,
  ...
  },
  {
    ...
    conditions: ['Severe Asthma', 'COPD (early stage)', 'Previous pneumothorax (2020)'],
    emergencyContacts: [
      { name: 'Nina Hofmann', phone: '+41 79 123 4568', relationship: 'Wife' },
      { name: 'Dr. Christian Wyss', phone: '+41 44 901 2345', relationship: 'Pulmonologist' },
    ],
    location: {
      lat: 47.3700,
      lng: 8.5300,
